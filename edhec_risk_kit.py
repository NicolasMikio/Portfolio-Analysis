...
def drawdown(return_series: pd.Series, valor=0, column="Close"):
    """
    Retorna um DataFrame com o Wealth Index, Previous Peak, e o Drawdown da série temporal dos retornos
    """
    if valor == 0:
        valor = float (input("Qual o S_0? "))
    wealth_index = valor*(1+return_series[column]).cumprod()
